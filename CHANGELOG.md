...
- K8s manifests now inject `GOVRIX_DATABASE_URL` and `GOVRIX_API_KEY` from secrets
...
- `GOVRIX_API_KEY` bearer token auth documented in DEPLOYMENT.md and DEVELOPMENT.md
...
### Added
- govrix-scout-common: PlatformConfig, LicenseTier (Community/Starter/Growth/Enterprise), TenantRegistry

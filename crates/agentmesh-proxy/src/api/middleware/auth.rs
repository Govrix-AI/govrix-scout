...
//!
//! If `AGENTMESH_API_KEY` is set, all requests to the management API must
...
impl AuthConfig {
    /// Load from the `AGENTMESH_API_KEY` environment variable.
    pub fn from_env() -> Self {
        Self {
            api_key: std::env::var("AGENTMESH_API_KEY").ok(),
        }
    }

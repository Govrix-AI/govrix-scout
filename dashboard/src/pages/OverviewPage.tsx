          ...
          {chartLoading ? (
            ...
            <ResponsiveContainer width="100%" height={180}>
              <AreaChart data={dailyData} margin={{ top: 4, right: 4, left: -18, bottom: 0 }}>
                <defs>
                  <linearGradient id="scout-reqGrad" x1="0" y1="0" x2="0" y2="1">
          ...
          {chartLoading ? (
            ...
            <ResponsiveContainer width="100%" height={180}>
              <BarChart data={topAgents} margin={{ top: 4, right: 4, left: -18, bottom: 0 }} barSize={14}>
                <defs>
                  <linearGradient id="scout-costGrad" x1="0" y1="0" x2="0" y2="1">
                ...
                />
                <Bar dataKey="cost" fill="url(#scout-costGrad)" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          )}
        </div>
